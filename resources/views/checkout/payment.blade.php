...
<?php
    ...
    <script>
        ...
        kwaiq.load('258922210021613');
         // Disparando o evento de Initiate Checkout
         kwaiq.instance('258922210021613').track('initiatedCheckout', {
                    content_id: '{{ $payment->order_id }}',       // ID do pedido ou do carrinho
                    value: {{ number_format((float) str_replace('.', '', str_replace('.', '', preg_replace("/[^0-9,]/", "", $description['valor']))), 2, '.', '') }},         // Valor total do carrinho
