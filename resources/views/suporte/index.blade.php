      ...
      <div class="mx-auto py-8">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="bg-white shadow-md rounded-lg p-6">
                  <h2 class="text-xl font-semibold text-gray-800 mb-4">Tutoriais</h2>
                  <div class="space-y-4">
                      <!-- Tutorial 1 -->
                      <div class="flex justify-between items-center">
                          ...
                          <a href="#" class="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition">Assistir</a>
                      </div>
              ...
              <div class="bg-white shadow-md rounded-lg p-6">
                  ...
                  <div class="space-y-4">
                      ...
                      <div class="flex justify-between items-center">
                          ...
                          <a href="#" class="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition">Contato</a>
                      </div>
                      ...
                      <div class="flex justify-between items-center">
                          ...
                          <a href="#" class="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition">Abrir link</a>
                      </div>
                  </div>
              </div>
          </div>
